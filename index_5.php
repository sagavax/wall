        ...
        if (navigator.geolocation) {
          ...
          function showPosition(position) {
              ...
              $.getJSON(url, function (data) {
                  ...
                  //$('<input>').attr('type','hidden').appendTo('#wall-comment-loc');
                  //$('#wall-comment-loc').append("<input type='text' name='location'/>"); 
                  ...
                  document.getElementById('wall-comment-val').appendChild(input);
                  document.getElementById('wall-comment-loc').innerHTML=address
              });
