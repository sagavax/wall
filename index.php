...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="sk" lang="sk">
   <head>
      ...
      function injectForm(theLink) {
        //document.getElementById("comment").value=theLink.innerHTML;
        document.getElementById("comment").value+=" "+theLink.innerHTML;
   ...
   <body onload="clock(); ">
   <button onclick="topFunction()" id="back_to_top" title="Go to top">Back to top</button>
               ...
               <!--- aktualny datum  -->
                  ...
                  <script>
                      ...
                      $(document).ready(function(){
                            ...
                            $('.diary_content').load('load_content.php');
                            $('#hashtags').load('load_hashtags.php');                                                               
                      });
                      ...
                      $(document).ready(function(){
                          $('#send_feed_form').submit(function(){
                              ...
                              $('.diary_content').html("<img src='img/loadBars.gif'>");
